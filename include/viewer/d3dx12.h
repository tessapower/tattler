//*****************************************************************************
// A single-file header providing all the CD3DX12_* helper classes needed for
// cleaner D3D12 code.
//
// Source:
// https://github.com/Microsoft/DirectX-Graphics-Samples/blob/master/MiniEngine/Core/d3dx12.h
// from Microsoft's DirectX-Graphics-Samples repository(MIT License)
//
...
struct CD3DX12_VIEWPORT : public D3D12_VIEWPORT
{
                              ...
                              FLOAT maxDepth = D3D12_MAX_DEPTH) noexcept
    {
        ...
        case D3D12_RESOURCE_DIMENSION_TEXTURE1D:
            ...
            TopLeftY = 0.0f;
            Width =
                (SubresourceWidth ? float(SubresourceWidth) : 1.0f) - topLeftX;
            Height = 1.0f;
            break;
        ...
        case D3D12_RESOURCE_DIMENSION_TEXTURE3D:
            ...
            Width =
                (SubresourceWidth ? float(SubresourceWidth) : 1.0f) - topLeftX;
            Height = (SubresourceHeight ? float(SubresourceHeight) : 1.0f) -
                     topLeftY;
            break;
        default:
            break;
...
struct CD3DX12_BOX : public D3D12_BOX
{
    ...
    explicit CD3DX12_BOX(LONG Left, LONG Top, LONG Front, LONG Right,
                         LONG Bottom, LONG Back) noexcept
    {
        left = static_cast<UINT>(Left);
        top = static_cast<UINT>(Top);
...
struct CD3DX12_DESCRIPTOR_RANGE1 : public D3D12_DESCRIPTOR_RANGE1
{
    ...
    explicit CD3DX12_DESCRIPTOR_RANGE1(
        const D3D12_DESCRIPTOR_RANGE1& o) noexcept
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
    ...
    CD3DX12_CPU_DESCRIPTOR_HANDLE& Offset(INT offsetInDescriptors,
                                          UINT descriptorIncrementSize) noexcept
    {
        ptr = SIZE_T(INT64(ptr) + INT64(offsetInDescriptors) *
    ...
    static inline void
    InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE& handle,
                  _In_ const D3D12_CPU_DESCRIPTOR_HANDLE& base,
                  INT offsetScaledByIncrementSize) noexcept
    {
        handle.ptr =
            SIZE_T(INT64(base.ptr) + INT64(offsetScaledByIncrementSize));
    }
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
    ...
    CD3DX12_GPU_DESCRIPTOR_HANDLE& Offset(INT offsetInDescriptors,
                                          UINT descriptorIncrementSize) noexcept
    {
        ptr = UINT64(INT64(ptr) + INT64(offsetInDescriptors) *
                                      INT64(descriptorIncrementSize));
        return *this;
    }
    ...
    static inline void
    InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE& handle,
                  _In_ const D3D12_GPU_DESCRIPTOR_HANDLE& base,
                  INT offsetScaledByIncrementSize) noexcept
    {
        handle.ptr =
            UINT64(INT64(base.ptr) + INT64(offsetScaledByIncrementSize));
    }
...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC
{
    ...
    CD3DX12_RESOURCE_DESC(D3D12_RESOURCE_DIMENSION dimension, UINT64 alignment,
                          ...
                          UINT16 mipLevels, DXGI_FORMAT format,
          ...
          UINT64 alignment = 0) noexcept
    {
        return CD3DX12_RESOURCE_DESC(D3D12_RESOURCE_DIMENSION_TEXTURE3D,
                                     alignment, width, height, depth, mipLevels,
                                     format, 1, 0, layout, flags);
    }
...
struct CD3DX12_RESOURCE_DESC1 : public D3D12_RESOURCE_DESC1
{
           ...
           UINT64 alignment = 0) noexcept
    {
        return CD3DX12_RESOURCE_DESC1(
            ...
            DXGI_FORMAT_UNKNOWN, 1, 0, D3D12_TEXTURE_LAYOUT_ROW_MAJOR, flags, 0,
            0, 0);
    }
    static inline CD3DX12_RESOURCE_DESC1
    Tex1D(DXGI_FORMAT format, UINT64 width, UINT16 arraySize = 1,
          ...
          UINT64 alignment = 0) noexcept
    {
        return CD3DX12_RESOURCE_DESC1(D3D12_RESOURCE_DIMENSION_TEXTURE1D,
                                      alignment, width, 1, arraySize, mipLevels,
    ...
    {
        return CD3DX12_RESOURCE_DESC1(
            D3D12_RESOURCE_DIMENSION_TEXTURE2D, alignment, width, height,
            arraySize, mipLevels, format, sampleCount, sampleQuality, layout,
            flags, samplerFeedbackMipRegionWidth,
    ...
    {
        return CD3DX12_RESOURCE_DESC1(
            D3D12_RESOURCE_DIMENSION_TEXTURE3D, alignment, width, height, depth,
                       ...
                       const D3D12_RESOURCE_DESC1& r) noexcept
{
    return l.Dimension == r.Dimension && l.Alignment == r.Alignment &&
           ...
           l.SampleDesc.Quality == r.SampleDesc.Quality &&
           l.Layout == r.Layout && l.Flags == r.Flags &&
           l.SamplerFeedbackMipRegion.Width ==
               r.SamplerFeedbackMipRegion.Width &&
                              ...
                              UINT NumSlices) noexcept
{
    ...
    {
        auto pDestSlice =
            static_cast<BYTE*>(pDest->pData) + pDest->SlicePitch * z;
                              ...
                              UINT NumSlices) noexcept
{
    for (UINT z = 0; z < NumSlices; ++z)
    {
        auto pDestSlice =
            static_cast<BYTE*>(pDest->pData) + pDest->SlicePitch * z;
        auto pSrcSlice =
            (static_cast<const BYTE*>(pResourceData) + pSrc->Offset) +
        ...
        case D3D_ROOT_SIGNATURE_VERSION_1_1:
        {
                ...
                for (UINT n = 0; n < desc_1_1.NumParameters; n++)
                {
                    ...
                    case D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE:
                        ...
                        auto pDescriptorRanges_1_0 =
                            static_cast<D3D12_DESCRIPTOR_RANGE*>(
                                pDescriptorRanges);
            ...
            if (SUCCEEDED(hr))
            {
                CD3DX12_ROOT_SIGNATURE_DESC desc_1_0(
                    ...
                    desc_1_1.Flags);
                hr = D3D12SerializeRootSignature(&desc_1_0,
                                                 D3D_ROOT_SIGNATURE_VERSION_1,
                                                 ppBlob, ppErrorBlob);
            }
...
struct CD3DX12_PIPELINE_STATE_STREAM2
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM2(
        ...
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask),
          ...
          GS(Desc.GS), StreamOutput(Desc.StreamOutput), HS(Desc.HS),
          DS(Desc.DS), PS(Desc.PS),
...
class CD3DX12_STATE_OBJECT_DESC
{
  public:
    ...
    operator const D3D12_STATE_OBJECT_DESC&()
    {
        ...
        // For subobjects with pointer fields, create a new copy of those
        // subobject definitions with fixed pointers
        for (UINT i = 0; i < m_Desc.NumSubobjects; i++)
        {
                ...
                D3D12_STATE_SUBOBJECT_TYPE_SUBOBJECT_TO_EXPORTS_ASSOCIATION)
            {
                ...
                Repointed.pSubobjectToAssociate =
                    pWrapper->pSubobjectArrayLocation;
        ...
        m_Desc.pSubobjects =
            m_Desc.NumSubobjects ? &m_SubobjectArray[0] : nullptr;
        return m_Desc;
    }
    operator const D3D12_STATE_OBJECT_DESC*()
    {
    ...
    //    etc.
    //
    // Alternatively, users can instantiate sububject helpers explicitly, such
    // as via local variables instead, passing the state object desc that should
    ...
    // object it is associated with is alive, else it's pointer references will
    // be stale. e.g.
    //
    //    CD3DX12_STATE_OBJECT_DESC
    ...
    : public CD3DX12_STATE_OBJECT_DESC::SUBOBJECT_HELPER_BASE
{
  public:
                      ...
                      D3D12_EXPORT_FLAGS Flags = D3D12_EXPORT_FLAG_NONE)
    {
        ...
        m_Desc.pExports = &m_Exports[0]; // using ugly way to get pointer in
                                         // case .data() is not defined
    ...
    : public CD3DX12_STATE_OBJECT_DESC::SUBOBJECT_HELPER_BASE
{
  public:
    ...
    {
        m_Desc.ClosestHitShaderImport =
            m_Strings[2].LocalCopy(importName, true);
    }
    void SetIntersectionShaderImport(LPCWSTR importName)
    {
        m_Desc.IntersectionShaderImport =
            m_Strings[3].LocalCopy(importName, true);
    }
    D3D12_STATE_SUBOBJECT_TYPE Type() const noexcept override
    {
